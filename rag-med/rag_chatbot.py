...
class RAGChatbot:
    ...
    def _load_and_process_document(self):
        ...
        try:
            ...
            text_splitter = RecursiveCharacterTextSplitter(
                # TODO: Configure the text splitter parameters
                # chunk_size=? (should be in 100-500), chunk_overlap=?, separators=?
            )
    ...
    def _retrieve_relevant_chunks(self, query: str, k: int = 3) -> List[str]:
        ...
        # TODO: Search for similar chunks and assign to docs variable
        # docs = self.vector_store.similarity_search(?, ?)
        
        #TODO: Complete the below line to return the page_content of each doc 
        return []
    ...
    def _generate_response(self, query: str, context_chunks: List[str]) -> str:
        ...
        context_text = "\n\n".join(context_chunks)
        #TODO: Include your prompt below
        prompt = f"""Create a cool prompt.
    ...
    def chat(self):
        ...
        while True:
            try:
                ...
                # TODO: Retrieve relevant chunks for the user question
                ...
                # TODO: response = self. (complete this line)
